...
void setup(){
  ...
  screen = 1;
  background(0);
  card1 = createGraphics(1280,720);
  card2 = createGraphics(1280,720);
  card3 = createGraphics(1280,720);
  card4 = createGraphics(1280,720);
  card5 = createGraphics(1280,720);
  player1 = 0;
  player2 = 0;
...
card1.beginDraw();
  card1.fill(255,0,0);
  card1.rect(0,0,200,280);
card1.endDraw();


card2.beginDraw();
  card2.fill(255,255,0);
  card2.rect(0,0,200,280);
card2.endDraw();


card3.beginDraw();
  card3.fill(0,255,0);
  card3.rect(0,0,200,280);
card3.endDraw();


card4.beginDraw();
  card4.fill(0,255,255);
  card4.rect(0,0,200,280);
card4.endDraw();


card5.beginDraw();
  card5.fill(0,0,255);
  card5.rect(0,0,200,280);
card5.endDraw();
